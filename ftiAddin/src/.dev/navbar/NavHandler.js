    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.ftiAddin.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.ftiAddin.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'ftiAddin'){
                    geotab.addin.ftiAddin.blur();
                } else {
                    geotab.addin.ftiAddin.focus(global.api, global.state);
                }
            }
        }, 100);
    }
